...
import { signUpFormValidation} from './AngeloAuthentication/Authentication';
...
function SignUpForm() {
    ...
    const consoleLogCallback = useCallback((newState) => {
        console.log(newState);
    },[])
    
    useEffect(() => {
        console.log('Page rendering')
        consoleLogCallback(formInputValues.firstName);
    }, [consoleLogCallback,formInputValues.firstName])
